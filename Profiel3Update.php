<?php
/*
Plugin Name: profiel3 persoonsgegevens wijzigen
...
require_once(STUDENT__PLUGIN_DIR . "Profiel3UpdateAction.php"); 
...
function update3_form($atts) {
	...
	if (StudentUtilities::user_is_privileged(1)) {
		...
		*/
		...
		$form = Profiel3View::form($student, "update_form_action", $validation_errors);
	}
	return $form;
}
add_shortcode("update3_form", "update3_form");
?>
