...
<legend>" . __('Kenmerken', 'student') . "</legend>
	<form method='post' action='" . esc_url(admin_url('admin-post.php')) . "'>
        ...
        <fieldset style='border: 1px solid silver;'>
        <legend>" . __('Plek', 'student') . "</legend>
		<label for 'type_woning'>" . __('Type_woning', 'student') . ": </label>
        <select name='type_woning' id='type_woning'>
            <option value='Huis'>Huis</option>
            <option value='Beneden_woning'>Beneden woning</option>
            <option value='Boven_woning'>Boven woning</option>
            <option value='Woonboot'>Woonboot</option>
        </select>
        <input type='number' name='etage' id='etage' min='0' value='0'>
        </fieldset>
		<label for 'roken'>" . __('Roken', 'student') . ": </label>
		<select name='roken' id='roken'>
            <option value='Niet_roken'>Niet Roken</option>
            <option value='In_het_huis'>In het huis</option>
