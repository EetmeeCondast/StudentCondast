<?php
/*
Plugin Name: profiel 2 persoonsgegevens wijzigen
...
require_once(STUDENT__PLUGIN_DIR . "Profiel2UpdateAction.php"); 
add_action('admin_post_update_form_action', 'Profiel2UpdateAction::action');
/*
	Shortcode "update_form". Het "update person" formulier wordt getoond.
*/
function update2_form($atts) {
	$person_id = 0;
	if (isset($_POST)) {
	...
	if (StudentUtilities::user_is_privileged(1)) {
		...
		*/
		...
		$form = Profiel2View::form($student, "update2_form_action", $validation_errors);
	}
	return $form;
}
add_shortcode("update2_form", "update_form");
?>
